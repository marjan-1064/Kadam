...
//     let similarproducts=data.filter(arr=>arr.category===product.category&&arr.id!==product.id)
//     const decrementhandler=()=>{
//         console.log("decrementhandler called");
//      setquantity(quantity>1?quantity-1:1)
//     }
//     const incrementhandler=()=>{
//         console.log("incrementhandler called");
//      setquantity(quantity+1)
//     }
//     console.log("Product in CardView:", product)
//     const navigate = useNavigate();
//       const {handlecardclick}=useContext(CartContext);
//     return (
//         <div className="cardview">
//             <div className="cardcontents"><div className="mainimage"> <img src={product.image[mainimage]} alt={product.name} /></div>
//                 <div className="cardheadings">
//                     <p style={{"fontSize":"30px","fontWeight":"400","color":"rgb(45, 82, 75)"}}>{product.name}</p>
//                     <p>{Array.from({ length: Math.floor(product.rating) }).map((_, i) => {
//                                           return (
//                                               <i
//                                                   key={i}
...
//                                               )
//                                           }({product.reviews})</p>
//                                           <p style={{"color":"#8d8b8b"}}>Brand : <span style={{"color":"#117e54"}}>{product.brand}</span> </p>
//                                           <p className="price">Rs {product.price}</p>
                                         
//                 </div>
//             </div>
//             <div className="imageflex"> <div className="imagegallery">
//                 {product.image.map((img, index) => {
//                     return (<img src={img} key={index} alt="image" onClick={() => { setmainimage(index) }} />)
//                 }
//                 )}
//             </div>
           
//              <div className="cardviewbuttons">
//             <div className="quantity"><p>Quantity </p><button id="decrement" onClick={()=>{decrementhandler()}}><i class="fa-solid fa-minus"></i></button><p>{quantity}</p>
//                 <button id="increment" onClick={()=>{incrementhandler()}}><i class="fa-solid fa-plus"></i></button>
//             </div>
//             <div className="cartbuybtns">
...
//                 </div>
//                  <div className="cardviewwarranty">
//                 <h4 style={{color:"#8d8b8b"}}>Return & Warranty</h4>
//                 <div className="return"><i className="fa-solid fa-rotate-left" style={{color:"#8d8b8b"}} ></i><p>14 days easy return</p></div>
//             </div>
...
//                <p style={{"fontWeight":"700" ,fontSize:"19px","marginBottom":"15px" ,"color":"rgb(45, 82, 75)"}}>Product Details</p>
//                 <p style={{"fontWeight":"700" ,fontSize:"19px","marginBottom":"15px","color":"rgb(45, 82, 75)"}}>Description:</p>
//                 <p style={{"width":"70%","marginBottom":"15px"}}> {product.description}</p>
//                 <p style={{"fontWeight":"700" ,fontSize:"19px","marginBottom":"15px","color":"rgb(45, 82, 75)"}}>Features</p>
//                 {product.features.map((feature,index)=>{
//                     return(<li key={index} style={{"marginBottom":"10px","marginLeft":"20px"}}>{feature}</li>)
//                 })}
//                 <p style={{"fontWeight":"700" ,fontSize:"19px","marginBottom":"15px","color":"rgb(45, 82, 75)"}}>Material</p>
//                 <p style={{"marginBottom":"15px"}}>{product.material}</p>
//             </div>
...
//                 <div className="similarproducts">
//                  {similarproducts.slice(0,6).map((arr)=>(
//                     <div key={arr.id} className="collectioncard" onClick={()=>{console.log("Catalog se product:", arr);handlecardclick(arr);navigate("/CardView");}
//                                                       }>
...
//                                                                   )
//                                                               }({arr.reviews})</p>
//                                                           <button className="AddCart" onClick={()=>{handlecart}}>Add to Cart <i class="fa-solid fa-cart-shopping"></i></button>
//                                                       </div>
